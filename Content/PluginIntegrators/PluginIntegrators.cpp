...
//***************************************************************************
ZilchDefineType(PluginIntegrators, builder, type)
{
...
//***************************************************************************
PluginIntegrators::PluginIntegrators()
{
  Zilch::Console::WriteLine("PluginIntegrators::PluginIntegrators (Constructor)");
...
PluginIntegrators::~PluginIntegrators()
{
  Zilch::Console::WriteLine("PluginIntegrators::~PluginIntegrators (Destructor)");
  // Always check for null if you are intending
  // to destroy any cogs that you 'own'
}

//***************************************************************************
void PluginIntegrators::Initialize(ZeroEngine::CogInitializer* initializer)
{
  Zilch::Console::WriteLine("PluginIntegrators::Initialize");
  
  ZeroConnectThisTo(this->GetSpace(), "LogicUpdate", "OnLogicUpdate");
}

//***************************************************************************
void PluginIntegrators::OnLogicUpdate(ZeroEngine::UpdateEvent* event)
{
  ...
  Zilch::HandleOf<PluginIntegratorsEvent> toSend = ZilchAllocate(PluginIntegratorsEvent);
  toSend->mLives = mLives;
  this->GetOwner()->DispatchEvent("PluginIntegratorsUpdate", toSend);
}

//***************************************************************************
Zilch::String PluginIntegrators::Speak()
{
...
//***************************************************************************
float PluginIntegrators::GetHealth()
{
  return mHealth;
}

//***************************************************************************
void PluginIntegrators::SetHealth(float value)
{
  if (value < 0)
    value = 0;
  else if (value > 100)
...
//***************************************************************************
ZilchDefineType(PluginIntegratorsEvent, builder, type)
{
